int line_width[12] = {1,1,2,2,2,2,2,2,2,2,2,2};
...
void Overlay1D(){
  ...
  int n_files=1;
    ...
    f[0] = new TFile("Plots3.root");
    
    vector<string> filetag=  {"BDT vs DRN"};
...
{{"DRN_corrbyGen","BDT_corrbyGen"},"DRN vs BDT","E_corr/E_gen",4,0,40,0.5,1.5,{"DRN","BDT"}},
};
